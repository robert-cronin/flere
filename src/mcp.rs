...
("message_status","Read one message and separate saved, queued, prompt-submitted, surfaced and acknowledged state. Own recipient reads surface that message; never acknowledges it.",schema(json!({"id":{"type":"string"}}),&["id"])),
