...
downloads match the sealed immutable release from source `9fbd2db`, published by
...
selects Linux v0.3.9 or the unsigned macOS arm64 v0.3.0 prebuilt from the
...
| [Cargo / crates.io](https://crates.io/crates/flere/0.3.9) | Core source package for Linux/macOS | Published v0.3.9 through Trusted Publishing from the matching GitHub source. Companion excluded |
| [Debian `.deb`](#install-the-debian-package) | Linux x86_64 with glibc 2.39+ | v0.3.9 download published and independently inspected; native Ubuntu lifecycle and missing-Git download checks passed for v0.3.2 |
