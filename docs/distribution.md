...
[Flere v0.3.14](https://github.com/robert-cronin/flere/releases/tag/v0.3.14) provides
...
downloads match the sealed immutable release from source `84c00a6`, published by
[run 35435727869](https://github.com/robert-cronin/flere/actions/runs/35435727869).
...
selects Linux v0.3.14 or the unsigned macOS arm64 v0.3.0 prebuilt from the
...
| [Cargo / crates.io](https://crates.io/crates/flere/0.3.14) | Core source package for Linux/macOS | Published v0.3.14 through Trusted Publishing from the matching GitHub source. Companion excluded |
| [Debian `.deb`](#install-the-debian-package) | Linux x86_64 with glibc 2.39+ | v0.3.14 download published and independently inspected; native Ubuntu lifecycle and missing-Git download checks passed for v0.3.2 |
