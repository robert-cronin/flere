...
v0.3.11 and the unsigned macOS arm64 v0.3.0 prebuilt. See the [terminal installation guide](docs/getting-started.md#install-from-your-terminal)
...
The [Cargo package](https://crates.io/crates/flere/0.3.11) builds locally on Linux
...
See the [0.3.11 release notes](docs/releases/0.3.11.md) for automatic-turn hook fixes and clearer worker startup guidance.
